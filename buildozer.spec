...
android.permissions = FOREGROUND_SERVICE,FOREGROUND_SERVICE_SPECIAL_USE,PACKAGE_USAGE_STATS
android.services = monitor:services/monitor.py:foreground:sticky:foregroundServiceType=specialUse
