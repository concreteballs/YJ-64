"""Typed domain models for telemetry processing."""
...
class TelemetryPacket:
    """Validated telemetry packet received from a node."""
    ...
    def from_mapping(cls, payload: Mapping[str, Any]) -> "TelemetryPacket":
        ...
        return cls(node_id=node_id.strip(), entropy=entropy_value, autonomy=autonomy_value)


@dataclass(frozen=True, slots=True)
class DiagnosticResult:
    """Result emitted by the diagnostic validation stage."""
